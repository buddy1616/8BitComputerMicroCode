...
{
    public class JumpCloseInstructionsBuilder : MicroCodeInstructionBuilder
    {
        ...
        public override List<int> Build()
        {
            ...
            //JMPC
            InstructionList.AddRange(BuildInstructionSet_CarryFlagDependent(new List<int> { NEXT_BYTE, NEXT_BYTE }, GetJumpInstructions()));

            //JPNC
            InstructionList.AddRange(BuildInstructionSet_CarryFlagDependent(GetJumpInstructions(), new List<int> { NEXT_BYTE, NEXT_BYTE }));

            //JMPZ
            InstructionList.AddRange(BuildInstructionSet_ZeroFlagDependent(new List<int> { NEXT_BYTE, NEXT_BYTE }, GetJumpInstructions()));

            //JPNZ
            InstructionList.AddRange(BuildInstructionSet_ZeroFlagDependent(GetJumpInstructions(), new List<int> { NEXT_BYTE, NEXT_BYTE }));

            //JMPE
            InstructionList.AddRange(BuildInstructionSet_EqualFlagDependent(new List<int> { NEXT_BYTE, NEXT_BYTE }, GetJumpInstructions()));

            //JPNE
            InstructionList.AddRange(BuildInstructionSet_EqualFlagDependent(GetJumpInstructions(), new List<int> { NEXT_BYTE, NEXT_BYTE }));

            //JMPG
            InstructionList.AddRange(BuildInstructionSet_GreaterFlagDependent(new List<int> { NEXT_BYTE, NEXT_BYTE }, GetJumpInstructions()));

            //JPNG
            InstructionList.AddRange(BuildInstructionSet_GreaterFlagDependent(GetJumpInstructions(), new List<int> { NEXT_BYTE, NEXT_BYTE }));
